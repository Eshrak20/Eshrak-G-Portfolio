...
const Blog = () => {
  ...
  const filteredBlogs =
    filter === "all"
      ? dummyBlogs.data
      : dummyBlogs.data.filter(
          (blog) => blog.category === filter || blog.type === filter
        );

  return (
    <>
      <DynamicBanner title="Blog Section" breadcrumb="Home / About Us" />
      ...
      <BlogPagination links={dummyBlogs.links} />
    </>
  );
};
